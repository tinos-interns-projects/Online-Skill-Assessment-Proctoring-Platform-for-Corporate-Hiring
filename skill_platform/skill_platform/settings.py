"""
Django settings for skill_platform project.
...
SECRET_KEY = 'django-insecure-8w^s&)qmugr$an42=!&e_)73r8$bf^t6+d%mx03k0i%vjwee&8'
...
WSGI_APPLICATION = 'skill_platform.wsgi.application'
